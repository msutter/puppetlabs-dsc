...
Puppet::Type.newtype(:dsc_xscsmapowershellsetup) do
  ...
  @doc = %q{
    ...
    'xSCSMA/DSCResources/MSFT_xSCSMAPowerShellSetup/MSFT_xSCSMAPowerShellSetup.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSCSMAPowerShellSetup' end
  def dscmeta_resource_name; 'MSFT_xSCSMAPowerShellSetup' end
  ...
  newparam(:dsc_ensure) do
    ...
    desc "Ensure - An enumerated value that describes if SMA PowerShell is expected to be installed on the machine.\nPresent {default}  \nAbsent   \n Valid values are Present, Absent."
    isrequired
    validate do |value|
