...
Puppet::Type.newtype(:dsc_xscdpmconsolesetup) do
  ...
  @doc = %q{
    ...
    'xSCDPM/DSCResources/MSFT_xSCDPMConsoleSetup/MSFT_xSCDPMConsoleSetup.schema.mof'
  ...
  newparam(:dsc_ensure) do
    ...
    desc "Ensure - An enumerated value that describes if the DPM console is expected to be installed on the machine.\nPresent {default}  \nAbsent   \n Valid values are Present, Absent."
    isrequired
    validate do |value|
