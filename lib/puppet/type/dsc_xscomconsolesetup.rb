...
Puppet::Type.newtype(:dsc_xscomconsolesetup) do
  ...
  @doc = %q{
    ...
    'xSCOM/DSCResources/MSFT_xSCOMConsoleSetup/MSFT_xSCOMConsoleSetup.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSCOMConsoleSetup' end
  def dscmeta_resource_name; 'MSFT_xSCOMConsoleSetup' end
  ...
  newparam(:dsc_ensure) do
    ...
    desc "Ensure - An enumerated value that describes if the OM Console is expected to be installed on the machine.\nPresent {default}  \nAbsent   \n Valid values are Present, Absent."
    isrequired
    validate do |value|
