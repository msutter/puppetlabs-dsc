...
Puppet::Type.newtype(:dsc_xdnsserverforwarder) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xDnsServerForwarder resource type.
    Automatically generated from
    'xDnsServer/DSCResources/MSFT_xDnsServerForwarder/MSFT_xDnsServerForwarder.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xDnsServerForwarder' end
  def dscmeta_resource_name; 'MSFT_xDnsServerForwarder' end
  ...
  # IsMandatory:  False
  # Values:       None
  newparam(:dsc_ipaddresses, :array_matching => :all) do
    def mof_type; 'string[]' end
    def mof_is_embedded?; false end
    desc "IPAddresses"
    validate do |value|
