...
Puppet::Type.newtype(:dsc_xscommanagementserverupdate) do
  ...
  @doc = %q{
    ...
    'xSCOM/DSCResources/MSFT_xSCOMManagementServerUpdate/MSFT_xSCOMManagementServerUpdate.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSCOMManagementServerUpdate' end
  def dscmeta_resource_name; 'MSFT_xSCOMManagementServerUpdate' end
