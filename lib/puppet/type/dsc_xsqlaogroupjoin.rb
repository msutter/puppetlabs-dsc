...
Puppet::Type.newtype(:dsc_xsqlaogroupjoin) do
...
Puppet::Type.type(:dsc_xsqlaogroupjoin).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
