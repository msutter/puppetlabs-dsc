...
Puppet::Type.newtype(:dsc_xscspfserverupdate) do
  ...
  @doc = %q{
    ...
    'xSCSPF/DSCResources/MSFT_xSCSPFServerUpdate/MSFT_xSCSPFServerUpdate.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSCSPFServerUpdate' end
  def dscmeta_resource_name; 'MSFT_xSCSPFServerUpdate' end
