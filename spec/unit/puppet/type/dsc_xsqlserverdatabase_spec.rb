...
describe Puppet::Type.type(:dsc_xsqlserverdatabase) do
  ...
  it "should stringify normally" do
    expect(dsc_xsqlserverdatabase.to_s).to eq("Dsc_xsqlserverdatabase[foo]")
  end
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xsqlserverdatabase[:dsc_ensure] = 'present'
    expect(dsc_xsqlserverdatabase[:ensure]).to eq(dsc_xsqlserverdatabase[:dsc_ensure].downcase.to_sym)
  end

  it 'should accept dsc_ensure predefined value Absent' do
    dsc_xsqlserverdatabase[:dsc_ensure] = 'Absent'
    expect(dsc_xsqlserverdatabase[:dsc_ensure]).to eq('Absent')
  end
  ...
  it 'should not accept values not equal to predefined values' do
    expect{dsc_xsqlserverdatabase[:dsc_ensure] = 'invalid value'}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept array for dsc_ensure' do
    expect{dsc_xsqlserverdatabase[:dsc_ensure] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_ensure' do
    expect{dsc_xsqlserverdatabase[:dsc_ensure] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_sqlserver' do
    expect{dsc_xsqlserverdatabase[:dsc_sqlserver] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_sqlinstancename' do
    expect{dsc_xsqlserverdatabase[:dsc_sqlinstancename] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  describe "powershell provider tests" do
    ...
    it "should successfully instanciate the provider" do
      described_class.provider(:powershell).new(dsc_xsqlserverdatabase)
    end

    before(:each) do
      @provider = described_class.provider(:powershell).new(dsc_xsqlserverdatabase)
    end
    ...
    describe "when dsc_ensure is 'present'" do
      ...
      before(:each) do
        dsc_xsqlserverdatabase.original_parameters[:dsc_ensure] = 'present'
        dsc_xsqlserverdatabase[:dsc_ensure] = 'present'
        @provider = described_class.provider(:powershell).new(dsc_xsqlserverdatabase)
      end
    ...
    describe "when dsc_ensure is 'absent'" do
      ...
      before(:each) do
        dsc_xsqlserverdatabase.original_parameters[:dsc_ensure] = 'absent'
        dsc_xsqlserverdatabase[:dsc_ensure] = 'absent'
        @provider = described_class.provider(:powershell).new(dsc_xsqlserverdatabase)
      end

      it "should update :ensure to :absent" do
        expect(dsc_xsqlserverdatabase[:ensure]).to eq(:absent)
      end
